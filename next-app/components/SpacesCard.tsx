          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button
                variant="destructive"
                size="lg"
                className="w-full rounded-lg bg-red-700 shadow-md transition-colors duration-300 hover:bg-red-600 hover:shadow-red-600/50 md:w-auto"
            ...
            <DialogContent className="w-full sm:max-w-[425px]">
              ...
              <DialogFooter className="flex flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0">
                ...
                <Button
                  type="submit"
                  className="w-full rounded-lg bg-red-700 text-white shadow-md transition-colors duration-300 hover:bg-red-600 hover:shadow-red-600/50 sm:w-auto"
