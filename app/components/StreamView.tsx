        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-5 w-screen max-w-screen-xl pt-8">
          <div className="col-span-3">
            <div className="space-y-4 p-4">
              <h2 className="text-2xl font-bold text-white text-center lg:text-start">Upcoming Songs</h2>
              {queue.length === 0 && (
              ...
              {queue.map((video) => (
                ...
                <Card key={video.id} className="bg-gray-900 border-gray-800">
                  <CardContent className="p-4 flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 sm:p--5">
                    <Image
                      src={video.smallImg}
                    ...
                    <div className="flex-grow flex flex-row sm:flex-col sm:text-left">
