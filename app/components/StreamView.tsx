...
export default function StreamView({
  ...
  const checkInput = (event: any) => {
    ...
    if(ytlink == "" || ytlink == null) {
        console.log("Yt is trigger ");
    }
    else {
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-5 w-screen max-w-screen-xl pt-8">
                ...
                <div className='col-span-2'>
                    <div className="max-w-4xl mx-auto p-4 space-y-6 w-full">
                        ...
                        />
                        <Button disabled={loading} onClick={handleSubmit} className="w-full bg-purple-700 hover:bg-purple-800 text-white">
